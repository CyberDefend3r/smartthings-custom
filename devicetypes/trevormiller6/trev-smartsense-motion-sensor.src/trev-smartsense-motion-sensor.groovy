 ...
 *
 * Modified by trevormiller6 to show Temperature as main display.
 *
...
metadata {
	definition(name: "Trev SmartSense Motion Sensor", namespace: "trevormiller6", author: "SmartThings, trevor", runLocally: true, minHubCoreVersion: '000.017.0012', executeCommandsLocally: false, mnmn: "SmartThings", vid: "generic-motion", genericHandler: "Zigbee") {
	...
	tiles(scale: 2) {
		...
		details(["temperature", "motion", "battery", "refresh"])
	}
}

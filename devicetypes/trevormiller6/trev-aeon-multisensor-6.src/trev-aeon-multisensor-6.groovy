...
metadata {
	definition(name: "Trev Aeon Multisensor 6", namespace: "trevormiller6", author: "SmartThings, trevor", runLocally: true, minHubCoreVersion: '000.020.00008', executeCommandsLocally: true, ocfDeviceType: "x.com.st.d.sensor.motion") {
